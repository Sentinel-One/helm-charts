...
{{- define "admissionControllers.mutating.name" -}}
{{- ( printf "%s-%s" .Release.Name "mutating-admission-controller" ) -}}
{{- end -}}
...
{{- or .Values.configuration.env.injection.enabled
       ...
       .Values.configuration.env.admission_controllers.mutating.enabled }}
{{- end -}}
...
{{- $_ := set $helperConfig "S1_MUTATING_ADMISSION_CONTROLLER_ENABLED" (printf "%t" .Values.configuration.env.admission_controllers.mutating.enabled) -}}
{{- $helperConfig | toYaml -}}
{{- end -}}
